...
* @since Maglis1.0
*/
if( ! class_exists( 'Maglist_Excerpt' ) ):

class Maglist_Excerpt{
...
/**
* Call to Maglist_Excerpt
*
* @since  1.0
* @uses   Maglist_Excerpt:::get_instance()->excerpt()
* @param  int $length
* @return void
*/
if( ! function_exists( 'maglist_excerpt' ) ):

    function maglist_excerpt( $length = 55, $echo = true, $more = '', $page_id = false ) {
        return Maglist_Excerpt::get_instance()->excerpt( $length, $echo, $more, $page_id );
    }
endif;