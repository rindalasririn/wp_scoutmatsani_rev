...
if ( class_exists('WP_Customize_Control' ) ) {
	class Maglist_Customizer_Color_Control extends WP_Customize_Control {
...
maglist_Customizer::add_custom_control(array(
	'type'     => 'color-picker',
	'class'    => 'Maglist_Customizer_Color_Control',
	'sanitize' => array('Maglist_Customizer', 'sanitize_rgba'),
));
