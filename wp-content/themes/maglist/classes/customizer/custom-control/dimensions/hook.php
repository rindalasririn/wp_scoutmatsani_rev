...
if( !class_exists( 'Maglist_Customizer_Dimensions_Integration' ) ){

	class Maglist_Customizer_Dimensions_Integration extends Maglist_Customizer{
		...
		public static $class = 'Maglist_Customizer_Dimensions_Control';
		...
		public function start( $instance , $wp_customize ){
			...
			foreach( $instance::$fields[ self::$type ] as $field ){
				...
				if( !isset( $field[ 'dimension' ] ) ){
					$err = esc_html__( 'Missing key "dimension" passed for Dimension Control.', 'maglist' );
	...
	new Maglist_Customizer_Dimensions_Integration();
}
