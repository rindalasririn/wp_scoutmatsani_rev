...
if (class_exists('WP_Customize_Control')) {
	class Maglist_Customizer_Icon_Select_Control extends WP_Customize_Control
	{
		...
		public function enqueue() {
			...
			wp_register_style(
				'font-awesome',
				Maglist_Helper::get_theme_uri( 'assets/css/vendor/font-awesome/css/font-awesome.css' ),
				array(),
				'4.7.0'
			);
...
Maglist_Customizer::add_custom_control(array(
	'type'     => 'icon',
	'class'    => 'Maglist_Customizer_Icon_Select_Control',
	'sanitize' =>  array( 'Maglist_Customizer', 'sanitize_choice' )
));
