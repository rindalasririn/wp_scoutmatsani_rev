 ...
 * @since 1.0
 *
 * @package Maglist WordPress
 */

if ( class_exists( 'WP_Customize_Control' ) ) :

    class Maglist_Customizer_Reset extends WP_Customize_Control {
        ...
        public function scripts() {
            wp_localize_script( Maglist_Helper::with_prefix( 'customize-js' ), 'CUSTOMIZERRESET', array(
                'nonce'   => array(
                    'reset' => wp_create_nonce( 'customizer-reset' ),
                ),
                'confirm' => esc_html__( 'This action is not reversible! Are you sure to reset these settings?', 'maglist' )
            ));
        }
...
Maglist_Customizer::add_custom_control(array(
    'type'     => 'reset',
    'class'    => 'Maglist_Customizer_Reset',
    'sanitize' => false,
