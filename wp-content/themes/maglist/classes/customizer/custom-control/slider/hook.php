 ...
 */
if (!class_exists('Maglist_Customizer_Slider_Integration')) {
	class Maglist_Customizer_Slider_Integration extends Maglist_Customizer
	{
		...
		public static $class = 'Maglist_Customizer_Slider_Control';
	...
	new Maglist_Customizer_Slider_Integration();
}
