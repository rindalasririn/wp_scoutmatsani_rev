...
/**
 * Customizer Control: maglist-toggle.
 *
 * @since 1.0
 *
 ...
 * @access public
 */
class Maglist_Toggle_Control extends WP_Customize_Control {
...
maglist_Customizer::add_custom_control(array(
	'type'     => 'toggle',
	'class'    => 'Maglist_Toggle_Control',
	'sanitize' => array( 'Maglist_Customizer', 'sanitize_checkbox' )
));
